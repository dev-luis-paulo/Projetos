...
#ifndef TEMPO_APP_SWIFT_H
#define TEMPO_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Tempo_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Tempo_App11AppDelegate")
...
SWIFT_CLASS("_TtC9Tempo_App26DailyForecastTableViewCell")
...
SWIFT_CLASS("_TtC9Tempo_App13SceneDelegate")
...
SWIFT_CLASS("_TtC9Tempo_App14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(Tempo_App)) <UICollectionViewDataSource>
...
@interface ViewController (SWIFT_EXTENSION(Tempo_App)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC9Tempo_App26previsaoCollectionViewCell")
@interface previsaoCollectionViewCell : UICollectionViewCell
